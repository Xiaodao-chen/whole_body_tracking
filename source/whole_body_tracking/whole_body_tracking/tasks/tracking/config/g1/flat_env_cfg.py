...
from whole_body_tracking.tasks.tracking.tracking_env_cfg import TrackingEnvCfg, CatParkourEnvCfg, SpeedParkourEnvCfg

@configclass
class G1SpeedParkourEnvCfg(SpeedParkourEnvCfg):
